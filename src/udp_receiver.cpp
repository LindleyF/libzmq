...
zmq::udp_receiver_t::udp_receiver_t (class io_thread_t *parent_,
...
zmq::udp_receiver_t::~udp_receiver_t ()
{
    delete decoder;
}
...
void zmq::udp_receiver_t::terminate ()
{
    unplug ();
    delete this;
}
...
void zmq::udp_receiver_t::restart_output ()
{
    drop_subscriptions ();
}
...
void zmq::udp_receiver_t::out_event (fd_t fd_)
{
    assert (false);
}

void zmq::udp_receiver_t::drop_subscriptions ()
{
    msg_t msg;
